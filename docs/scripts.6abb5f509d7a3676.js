  ...
  d && Object.deepExtend(e, d),
    ...
    (e.fn.particle = function (a, i, t) {
      if (
        ...
        this.x > e.canvas.w - 2 * this.radius
          ? (this.x = this.x - this.radius)
          : this.x < 2 * this.radius && (this.x = this.x + this.radius),
        this.y > e.canvas.h - 2 * this.radius
    ...
    (e.fn.particle.prototype.draw = function () {
      var a = this;
      if (null != a.radius_bubble) var i = a.radius_bubble;
      else i = a.radius;
      if (null != a.opacity_bubble) var t = a.opacity_bubble;
      else t = a.opacity;
      if (a.color.rgb)
        var s =
          "rgba(" +
        ...
        s =
          ...
          ")";
      switch (
        ((e.canvas.ctx.fillStyle = s), e.canvas.ctx.beginPath(), a.shape)
      ) {
        case "circle":
          e.canvas.ctx.arc(a.x, a.y, i, 0, 2 * Math.PI, !1);
          break;
        case "edge":
          e.canvas.ctx.rect(a.x - i, a.y - i, 2 * i, 2 * i);
          break;
        case "triangle":
        ...
        case "polygon":
          e.fn.vendors.drawShape(
            ...
            a.y - i / 0.76,
            (2.66 * i) / (e.particles.shape.polygon.nb_sides / 3),
        ...
        case "star":
          e.fn.vendors.drawShape(
            e.canvas.ctx,
            a.x - (2 * i) / (e.particles.shape.polygon.nb_sides / 4),
            a.y - i / 1.52,
            (2 * i * 2.66) / (e.particles.shape.polygon.nb_sides / 3),
            e.particles.shape.polygon.nb_sides,
            2
          );
          break;
        case "image":
          ...
          if ("svg" == e.tmp.img_type) var n = a.img.obj;
          else n = e.tmp.img_obj;
          n && o();
      }
    ...
    (e.fn.particlesUpdate = function () {
      for (var a = 0; a < e.particles.array.length; a++) {
        ...
        if (
          ...
          "bounce" == e.particles.move.out_mode)
        )
          var s = {
            x_left: i.radius,
            x_right: e.canvas.w,
        ...
        if (
          ("bounce" ===
            (i.x - i.radius > e.canvas.w
              ? ((i.x = s.x_left), (i.y = Math.random() * e.canvas.h))
              : i.x + i.radius < 0 &&
                ((i.x = s.x_right), (i.y = Math.random() * e.canvas.h)),
            i.y - i.radius > e.canvas.h
              ? ((i.y = s.y_top), (i.x = Math.random() * e.canvas.w))
              : i.y + i.radius < 0 &&
                ((i.y = s.y_bottom), (i.x = Math.random() * e.canvas.w)),
            e.particles.move.out_mode) &&
            ((i.x + i.radius > e.canvas.w || i.x - i.radius < 0) &&
              (i.vx = -i.vx),
            (i.y + i.radius > e.canvas.h || i.y - i.radius < 0) &&
              (i.vy = -i.vy)),
          isInArray("grab", e.interactivity.events.onhover.mode) &&
            e.fn.modes.grabParticle(i),
          (isInArray("bubble", e.interactivity.events.onhover.mode) ||
            isInArray("bubble", e.interactivity.events.onclick.mode)) &&
            e.fn.modes.bubbleParticle(i),
          (isInArray("repulse", e.interactivity.events.onhover.mode) ||
            isInArray("repulse", e.interactivity.events.onclick.mode)) &&
          ...
          for (var n = a + 1; n < e.particles.array.length; n++) {
            var r = e.particles.array[n];
            e.particles.line_linked.enable && e.fn.interact.linkParticles(i, r),
              e.particles.move.attract.enable &&
                e.fn.interact.attractParticles(i, r),
              e.particles.move.bounce && e.fn.interact.bounceParticles(i, r);
          }
      }
    }),
    ...
    (e.fn.interact.attractParticles = function (a, i) {
      var t = a.x - i.x,
        s = a.y - i.y;
      if (Math.sqrt(t * t + s * s) <= e.particles.line_linked.distance) {
        var r = t / (1e3 * e.particles.move.attract.rotateX),
          o = s / (1e3 * e.particles.move.attract.rotateY);
        (a.vx -= r), (a.vy -= o), (i.vx += r), (i.vy += o);
      }
    }),
    (e.fn.interact.bounceParticles = function (a, i) {
      var t = a.x - i.x,
        s = a.y - i.y;
      Math.sqrt(t * t + s * s) <= a.radius + i.radius &&
      ...
      if (
        ...
        var i = a.x - e.interactivity.mouse.pos_x,
          ...
          n =
            ...
            (s = Math.sqrt(i * i + t * t)) /
              e.interactivity.modes.bubble.distance;
        if (s <= e.interactivity.modes.bubble.distance) {
          if (n >= 0 && "mousemove" == e.interactivity.status) {
            if (e.interactivity.modes.bubble.size != e.particles.size.value)
              if (e.interactivity.modes.bubble.size > e.particles.size.value)
                (r = a.radius + e.interactivity.modes.bubble.size * n) >= 0 &&
                  (a.radius_bubble = r);
              else {
                var r;
                a.radius_bubble =
                  (r =
                    a.radius -
                    (a.radius - e.interactivity.modes.bubble.size) * n) > 0
                    ? r
                    : 0;
              }
            if (
              ...
              if (
                ...
                (v = e.interactivity.modes.bubble.opacity * n) > a.opacity &&
        ...
        "mouseleave" == e.interactivity.status && u();
      } else if (
        e.interactivity.events.onclick.enable &&
        isInArray("bubble", e.interactivity.events.onclick.mode)
      ) {
        let u = function (m, w, x, b, y) {
          if (m != w)
            if (e.tmp.bubble_duration_end)
              null != x &&
                ((_ =
                  ...
                  (m -
                    (b -
                      (f * (b - m)) / e.interactivity.modes.bubble.duration))),
                "size" == y && (a.radius_bubble = _),
                "opacity" == y && (a.opacity_bubble = _));
            else if (s <= e.interactivity.modes.bubble.distance) {
              if (null != x) var p = x;
              else p = b;
              if (p != m) {
                var _ =
                  b - (f * (b - m)) / e.interactivity.modes.bubble.duration;
                "size" == y && (a.radius_bubble = _),
                  "opacity" == y && (a.opacity_bubble = _);
              }
            } else
              "size" == y && (a.radius_bubble = void 0),
                "opacity" == y && (a.opacity_bubble = void 0);
        };
        if (e.tmp.bubble_clicking) {
          (i = a.x - e.interactivity.mouse.click_pos_x),
            (t = a.y - e.interactivity.mouse.click_pos_y);
          var s = Math.sqrt(i * i + t * t),
          ...
          f > e.interactivity.modes.bubble.duration &&
            ...
            f > 2 * e.interactivity.modes.bubble.duration &&
    ...
    (e.fn.modes.repulseParticle = function (a) {
      if (
        ...
        var i = a.x - e.interactivity.mouse.pos_x,
          ...
          n = { x: i / s, y: t / s },
          v = clamp(
            (1 / (r = e.interactivity.modes.repulse.distance)) *
              (-1 * Math.pow(s / r, 2) + 1) *
              r *
              100,
            0,
        ...
        if (
          ...
          let b = function () {
            var y = Math.atan2(h, g);
            if (
              ((a.vx = m * Math.cos(y)),
              (a.vy = m * Math.sin(y)),
              "bounce" == e.particles.move.out_mode)
            ) {
              var p = { x: a.x + a.vx, y: a.y + a.vy };
              (p.x + a.radius > e.canvas.w || p.x - a.radius < 0) &&
                (a.vx = -a.vx),
                (p.y + a.radius > e.canvas.h || p.y - a.radius < 0) &&
                  (a.vy = -a.vy);
            }
          };
          var r = Math.pow(e.interactivity.modes.repulse.distance / 6, 3),
          ...
          0 == e.tmp.repulse_clicking && ((a.vx = a.vx_i), (a.vy = a.vy_i));
    }),
    (e.fn.modes.grabParticle = function (a) {
      if (
        ...
        var i = a.x - e.interactivity.mouse.pos_x,
          t = a.y - e.interactivity.mouse.pos_y,
          s = Math.sqrt(i * i + t * t);
        if (s <= e.interactivity.modes.grab.distance) {
          var n =
            ...
            s /
              ...
              e.interactivity.modes.grab.distance;
          if (n > 0) {
            var r = e.particles.line_linked.color_rgb_line;
            (e.canvas.ctx.strokeStyle =
              "rgba(" + r.r + "," + r.g + "," + r.b + "," + n + ")"),
              (e.canvas.ctx.lineWidth = e.particles.line_linked.width),
              e.canvas.ctx.beginPath(),
    ...
    (e.fn.vendors.eventsListeners = function () {
      (e.interactivity.el =
        "window" == e.interactivity.detect_on ? window : e.canvas.el),
        (e.interactivity.events.onhover.enable ||
          e.interactivity.events.onclick.enable) &&
          (e.interactivity.el.addEventListener("mousemove", function (a) {
            if (e.interactivity.el == window)
              var i = a.clientX,
                t = a.clientY;
            else (i = a.offsetX || a.clientX), (t = a.offsetY || a.clientY);
          ...
          e.interactivity.el.addEventListener("click", function () {
            if (
              ...
              switch (e.interactivity.events.onclick.mode) {
                case "push":
                  e.particles.move.enable ||
                  1 == e.interactivity.modes.push.particles_nb
    ...
    (e.fn.vendors.densityAutoParticles = function () {
      if (e.particles.number.density.enable) {
        ...
        e.tmp.retina && (a /= 2 * e.canvas.pxratio);
        var t =
          e.particles.array.length -
    ...
    (e.fn.vendors.checkOverlap = function (a, i) {
      for (var t = 0; t < e.particles.array.length; t++) {
        var s = e.particles.array[t],
          n = a.x - s.x,
          r = a.y - s.y;
        Math.sqrt(n * n + r * r) <= a.radius + s.radius &&
    ...
    (e.fn.vendors.createSvgImg = function (a) {
      var s = e.tmp.source_svg.replace(
          /#([0-9A-F]{3,6})/gi,
          function (f, g, h, u) {
            if (a.color.rgb)
              var m =
    ...
    (e.fn.vendors.drawShape = function (a, i, t, s, n, r) {
      var o = n * r,
        v = n / r,
        g = Math.PI - (Math.PI * ((180 * (v - 2)) / v)) / 180;
      a.save(), a.beginPath(), a.translate(i, t), a.moveTo(0, 0);
      for (var h = 0; h < o; h++)
        a.lineTo(s, 0), a.translate(s, 0), a.rotate(g);
      a.fill(), a.restore();
    }),
      ...
      if (((e.tmp.img_error = void 0), "" != e.particles.shape.image.src))
        if ("svg" == a) {
          ...
          i.open("GET", e.particles.shape.image.src),
            (i.onreadystatechange = function (s) {
              4 == i.readyState &&
                (200 == i.status
                  ? ((e.tmp.source_svg = s.currentTarget.response),
    ...
    (e.fn.vendors.checkBeforeDraw = function () {
      "image" == e.particles.shape.type
        ? "svg" == e.tmp.img_type && null == e.tmp.source_svg
    ...
    (e.fn.vendors.init = function () {
      e.fn.retinaInit(),
        ...
        e.fn.particlesCreate(),
        e.fn.vendors.densityAutoParticles(),
        (e.particles.line_linked.color_rgb_line = hexToRgb(
          e.particles.line_linked.color
        ));
    }),
    (e.fn.vendors.start = function () {
      isInArray("image", e.particles.shape.type)
...
function hexToRgb(c) {
  c = c.replace(/^#?([a-f\d])([a-f\d])([a-f\d])$/i, function (e, a, i, t) {
    return a + a + i + i + t + t;
  });
...
(Object.deepExtend = function (c, d) {
  for (var l in d)
    d[l] && d[l].constructor && d[l].constructor === Object
      ? ((c[l] = c[l] || {}), arguments.callee(c[l], d[l]))
      : (c[l] = d[l]);
  return c;
}),
  ...
  (window.particlesJS = function (c, d) {
    "string" != typeof c && ((d = c), (c = "particles-js")),
      c || (c = "particles-js");
    ...
    (i.className = e),
      (i.style.width = "100%"),
      (i.style.height = "100%"),
      null != document.getElementById(c).appendChild(i) &&
        pJSDom.push(new pJS(c, d));
  }),
